(function () {
    ...
    function boot () {
        ...
        if (!false) {
            var bundledScript = settings.debug ? 'src/project.dev.49977.js' : 'src/project.js';
            if (jsList) {
    ...
    if (true) {
        require(window._CCSettings.debug ? 'cocos2d-js.16e8b.js' : 'cocos2d-js-min.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.16e8b.js' : 'cocos2d-js-min.js';
